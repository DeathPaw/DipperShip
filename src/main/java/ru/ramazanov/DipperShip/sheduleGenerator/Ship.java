...
import ru.ramazanov.DipperShip.models.ShipType;
    ...
    public Ship() {
        ...
        switch(random.nextInt(3)) {
            case 0:
                ...
                this.nominalWeight = random.nextInt(2) + 20;
                this.workingWeight = this.nominalWeight;
                break;
            case 1:
                this.shipType = ShipType.NORMAL;
                this.nominalWeight = random.nextInt(2) + 60;
                this.workingWeight = this.nominalWeight;
                break;
            case 2:
                this.shipType = ShipType.BIG;
                this.nominalWeight = random.nextInt(2) + 100;
                this.workingWeight = this.nominalWeight;
                break;
        }
        switch(random.nextInt(3)) {
